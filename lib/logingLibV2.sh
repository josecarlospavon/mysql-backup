...
#		The library will remember the highest level used (it starts on INFORMATION, when the first WARNING message is printed
##		it will change to WARNING until an ERROR message is printed when it will change to ERROR).
# ------------------------------------------------------------------------------------------		
